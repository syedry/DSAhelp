...
bool Graph::BFS(int s, int t) {
    ...
    // Here, level[] array works as visited array also.
    list< int > q;
    q.push_back(s);
...
// there is a possible flow and constructed levels. This function is called
// multiple times for a single call of BFS.

// flow : Current flow send by parent function call
// start[] : To keep track of next edge to be explored. start[i] stores count
//           of edges explored from i.
// u : Current vertex
// t : Sink
